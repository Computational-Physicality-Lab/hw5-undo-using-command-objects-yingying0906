		...
		<div className="Control">
			...
			<div style={{ display: "flex", alignItems: "center" }}>
				<input
					...
					onMouseUp={(e) => changedCurrBorderWidth()}
					min={1}
					max={30}
...
const UndoRedo = ({ commandList, currCommand, undo, redo }) => {
	let redoGrayedOut = currCommand === commandList.length - 1;
	let undoGrayedOut = currCommand === -1;
	return (
		<div className="Control">
			<h3>Undo / Redo:</h3>
	...
	return (
		<div className="ControlPanel">
			...
			<BorderWidth
				...
				changedCurrBorderWidth={changedCurrBorderWidth}
			/>
			<FillColor
				currFillColor={currFillColor}
